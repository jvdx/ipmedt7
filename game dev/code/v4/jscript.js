...
// var cvText=document.getElementById("textCanvas");
...
//generator die 0 of 1 bepaald voor het spawnen van verschillende collectanten

// var checkVar = Math.floor(Math.random() * 2);
...
achtergrond.src = '../straatv41.png';
	...
	// ctxText.font = "normal 30px Verdana";
	// ctxText.strokeStyle = "#000000";
	// ctxText.strokeText=("Score: ",50,90);
...
// nulEen();
	...
	// 	colCheck ++;
	// }else{
	// 	ctxBg.drawImage(collectant2,0,0,width,height,drawX+width,player.y+20,width-250,height-250);
	// colCheck
	// }	
	...
	ctx.fillText("Punten: " + punten,8,20);
