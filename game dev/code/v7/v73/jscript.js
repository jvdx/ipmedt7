...
function freezeGame()
{
	if((drawX >= -653) && (drawX <= -650))
	{
		...
		//text in textballon weergeven. later in case zetten en verschillende verhalen weergeven.
		// ctxGeld.font="19px Calibiri";
		// ctxGeld.fillText("Dit is text", 250, 160);
		// ctxGeld.fillText("in de textballon.", 230, 180);
		// ctxGeld.fillText("Hier komt een verhaal over ", 180, 200);
		// ctxGeld.fillText("de collectant", 180, 220);
...
function textSpawnen()
	{
		...
		ctxGeld.fillText("dit is de 2e case", 250,160);
		console.log("case(1)");
			break;

		case(2): ctxGeld.font="19 px Calibri";
		ctxGeld.fillText("3e case",250,160);
		console.log("case(2)");
		break;
		...
		// case(4); ctxGeld.font="19 px Calibri";
		// ctxGeld.fillText("5e case",250,160);
		// console.log("case(4)");
		// break;
...
freezeGame();
	...
	// textballon tekenen
	// ctxBg.drawImage(textBallonImg,0,0,width,height,player.x-300,player.y+20,200,200);
