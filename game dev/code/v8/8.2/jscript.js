...
//v0.8.2  char stoppen met lopen animatie bij collectant?
// 
//7 januari 2014
...
function textSpawnen()
	{
		...
		ctxText.fillText("is welkom!", 180, 240);
		...
		ctxText.fillText("Ik werk voor KWF", 220, 200);
		ctxText.fillText("kankerbestrijding. Hier ziet u ", 180, 220);
		ctxText.fillText("mijn identificatie. Zou u het KWF  ", 170, 240);
		...
		ctxText.fillText("4e case",250,160);
		console.log("case(3)");
		break;
