...
// v0.8.4 letters J en N en rechter arrow toevoegen als img voor duidelijkheid
//14 januari 2014
...
function hints()
{
	...
	ctxBg.drawImage(arrowR,0,0,47,44,450,550,47,44);
...
freezeGame();
	...
	ctxBg.drawImage(J,0,0,46,44,350,550,46,44);
	ctxBg.drawImage(N,0,0,46,44,400,550,46,44);
